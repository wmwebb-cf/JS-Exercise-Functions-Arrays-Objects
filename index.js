 ...
 * it will return `This is a Lincoln Navigator`.
*/
function getCarInfoById(/* code here */inv, num1) {
  /* code here */
...
function sortCarInventory(/* code here */inv) {
  /* code here */
  let newInv = inv.sort(function (x, y) {
...
function getModelYears(/* code here */inv) {
  /* code here */
  let modYrs = [];
  for (var i = 0; i < inv.length; i++) {
    modYrs.push(inv[i].car_year);
  }
  return modYrs;
}
...
*/
function getOlderCars(/* code here */inv, maxYear) {
  /* code here */
  let yearArr = [];
  for (var i = 0; i < inv.length; i++) {
    let desiredYr = inv[i].car_year;
    if (desiredYr <= maxYear) {
      yearArr.push(inv[i]);
    };
  }
  return yearArr;
 ...
 * in the same order as they appear in the original inventory.
*/
function getGermanCars(/* code here */inv) {
  /* code here */
  let germanCars = [];
  for (var i = 0; i < inv.length; i++) {
